...
# Change Web Idle Timeout
    idle = {
        "pkiWebTokenData": {
            "attributes":{"dn":"uni/userext/pkiext/webtokendata","uiIdleTimeoutSeconds":"9600"},"children":[]}}
    
    path = "/api/node/mo/uni/userext/pkiext/webtokendata.json"
    rsp = post_request(APIC_HOST, cookies, path, json.dumps(idle))
